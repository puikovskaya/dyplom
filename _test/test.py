...
def analyse_file(file_path, result_path, config_path):
    try:
        ...
        print(f"[OpenSmile] | File ({file_path}) failed to analyse")
...
def main():
    audiofiles_root_path = "C:/Job/Temp/opensmile-master/example-audio"
    results_root_path = "C:/Job/Temp/results/"
    conf = "C:/Job/Temp/opensmile-master/config/emobase/emobase.conf"
